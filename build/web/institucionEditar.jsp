    ...
    <body>
        ...
        <div class="sidebar d-flex flex-column justify-content-between p-3" style="position: fixed; top: 0; left: 0; width: 280px; height: 100vh; background-color: #C6E7FF;">
            <div>
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="row">
                        <a href="institucionesView.jsp" class="nav-link fw-bold" style="background-color: #004577; color: #FFFFFF;">
        ...
        <div class="content" style="margin-left: 280px; padding: 40px;">
            <div class="card" style="width: 70rem;">
                <h2 class="m-3">Editar Institucion</h2>
                <hr>
                <div class="row m-3">
                    <div class="row">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-4">
                            <br>
                            <input type="text" required="" class="form-control" id="ins" name="ins">
                        </div>
                    </div>
                    <br>
                    <input type="hidden" id="id" name="id">
                    <div class="col-12 text-end p-2">
                        <button type="submit" id="btnEditar" name="btnEditar" class="btn fw-bold" style="background: #004577; color: #fff;">Guardar</button>
                        <a href="institucionesView.jsp" class="btn fw-bold" style="background: #D4F6FF; color: #004577;">Cancelar</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script src="Assets/js/institucion.js"type="text/javascript"></script>
        ...
        <script>
            $(document).ready(function () {
                ...
                if (id) {
                    $.ajax({
                        url: 'institucionController',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {accion: 'seleccionar', id: id}
                    }).done(function (response) {
                        if (response.estado === 'success') {
                            $('#ins').val(response.usar.institucion);
                            $('#id').val(response.usar.id);
                        } else {
                    ...
                    Swal.fire('Error', 'No se encontró el dato en la URL', 'error');
                }
            });
        </script>
    </body>
