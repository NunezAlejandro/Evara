...
<html>
    ...
    <body>
        ...
        <div class="sidebar d-flex flex-column justify-content-between p-3" style="position: fixed; top: 0; left: 0; width: 280px; height: 100vh; background-color: #C6E7FF;">
            <div>
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="row">
                        <a href="alumnosView.jsp" class="nav-link fw-bold" style="background-color: #004577; color: #FFFFFF;">
            ...
            <div class="card" style="width: 70rem;">
                ...
                <div class="row m-3">
                    ...
                    <div class="col-12 text-end p-2">
                        ...
                        <a href="alumnosView.jsp" class="btn fw-bold" style="background: #D4F6FF; color: #004577;">Cancelar</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script src="Assets/js/alumno.js"type="text/javascript"></script>
                ...
                if (id) {
                    $.ajax({
                        ...
                        if (response.estado === 'success') {
                            ...
                            DropDown(response.usar.idUsuario);
                            DropDownInstitucion(response.usar.idInstitucion);
                        } else {
