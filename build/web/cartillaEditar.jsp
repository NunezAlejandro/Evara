    ...
    <body>
        ...
        <div class="content" style="margin-left: 280px; padding: 40px;">
            <div class="card" style="width: 70rem;">
                <h2 class="m-3">Editar Cartilla</h2>
                <hr>
                <div class="row m-3">
                    <div class="row">
                        <div class="col-md-2">
                ...
                if (id) {
                    $.ajax({
                        ...
                        if (response.estado === 'success') {
                            ...
                            $('#peso').val(response.usar.peso);
                            $('#talla').val(response.usar.talla);
                            $('#hemoglobina').val(response.usar.hemoglobina);
                            $('#glucosa').val(response.usar.glucosa);
