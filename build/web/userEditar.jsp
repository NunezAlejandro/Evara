...
<html>
    ...
    <body>
            ...
            <div class="card" style="width: 70rem;">
                ...
                <div class="row m-3">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <br>
                            <input type="text" required="" readonly="" disabled="" class="form-control" id="dni" name="dni">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-2">
        ...
        <script>
            const dni = <%= request.getParameter("dni")%>;
            if (dni) {
                $('#dni').val(dni);
                ...
                $.ajax({
                    ...
                    if (response.estado === 'success') {
                        $('#nom').val(response.usuario.nom);
                        $('#app').val(response.usuario.app);
                        $('#gen').val(response.usuario.gen);
                        $('#edad').val(response.usuario.edad);
                    } else {
                ...
                Swal.fire('Error', 'No se encontró el DNI en la URL', 'error');
            }
        </script>
    </body>
</html>
