...
<html>
    ...
    <body>
        ...
        <div class="sidebar d-flex flex-column justify-content-between p-3" style="position: fixed; top: 0; left: 0; width: 280px; height: 100vh; background-color: #C6E7FF;">
            <div>
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="row">
                        <a href="rolesView.jsp" class="nav-link fw-bold" style="background-color: #004577; color: #FFFFFF;">
        ...
        <div class="content" style="margin-left: 280px; padding: 40px;">
            <div class="card" style="width: 70rem;">
                ...
                <div class="col-12 text-end p-2">
                    <button type="submit" id="btnEditar" name="btnEditar" class="btnEditar btn fw-bold" style="background: #004577; color: #fff;">Guardar</button>
                    <a href="rolesView.jsp" class="btn fw-bold" style="background: #D4F6FF; color: #004577;">Cancelar</a>
                </div>
            </div>
        </div>
        ...
        <script src="Assets/js/rol.js"type="text/javascript"></script>
                ...
                if (id) {
                    $.ajax({
                        ...
                        if (response.estado === 'success') {
                            $('#rol').val(response.usar.rol);
                            $('#id').val(response.usar.id);
                            DropDown(response.usar.dni);
                        } else {
