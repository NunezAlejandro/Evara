...
<html>
    ...
    <body>
        ...
        <div class="row d-flex gap-5" style="margin-left: 280px; padding: 40px 0px 0px 40px; width: 100rem;">
            <div class="card col-6">
                <div class="row titulo">
                    <h2 class="m-3 h2">Indicadores</h2>
                    <hr>
                </div>
                <div class="col-6 ms-3 nuevo">
                    <a href="cartillaRegistrar.jsp" class="btn" style="background-color: #C6E7FF; color: #004577;"><strong>Nuevo</strong></a>
                </div>
                <div class="row m-3 tabla">
                </div>
            </div>
            <div class="card col-4 escolares">
                <div class="row">
                    <h2 class="p-3 d-flex align-items-center">
                        <div class="ms-2">
                            <img src="Assets/Image/estadistica.png" alt="alt/">
                        </div>
                        <div>
                            <span class="d-block ms-2" style="overflow: hidden;">
                ...
                <div class="row">
                    <div class="col-4 d-flex justify-content-center align-items-center">
                        <img src="Assets/Image/human.png" alt="alt/" style="height: 8rem; object-fit: contain;">
                    </div>
                    <div class="col-8">
                        <div class="row m-3 d-flex align-items-center">
                            <div class="col-2">
                                <img src="Assets/Image/up.png" alt="alt/">
                            </div>
                            <div class="col-3 text-center sanos">

                            </div>
                            <div class="col-5">
                                <span class="fw-bold" style="overflow: hidden;">Escolares saludables</span>
                            </div>
                        </div>
                        <div class="row m-3 d-flex align-items-center">
                            <div class="col-2">
                                <img src="Assets/Image/down.png" alt="alt/">
                            </div>
                            <div class="col-3 text-center nosanos">
                            </div>
                            <div class="col-5">
                                <span class="fw-bold" style="overflow: hidden;">Escolares enfermos</span>
                            </div>
                        </div>
                    </div>
                </div>
