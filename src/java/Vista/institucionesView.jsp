    ...
    <body>
        ...
        <div class="content" style="margin-left: 280px; padding: 40px;">
            <div class="card" style="width: 70rem;">
                <div class="row">
                    <h2 class="m-3">Instituciones</h2>
                </div>
                <hr>
                <div class="row d-flex justify-content-between align-items-center m-2">
                    <div class="col-6">
                        <a href="institucionRegistrar.jsp" class="btn fw-bold" style="background: #FFDDAE; color: #004577;">Nuevo</a>
                    </div>
