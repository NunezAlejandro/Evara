...
<html>
    ...
    <body>
        ...
        <div class="sidebar d-flex flex-column justify-content-between p-3" style="position: fixed; top: 0; left: 0; width: 280px; height: 100vh; background-color: #C6E7FF;">
            <div>
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="row">
                        <a href="#" class="nav-link fw-bold d-flex align-items-center" style="background-color: #004577; color: #FFFFFF;">
                            <div class="ms-2">
        ...
        <script src="Assets/js/parametro.js"type="text/javascript"></script>
    </body>
</html>
