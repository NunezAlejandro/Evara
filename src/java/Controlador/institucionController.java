...
@WebServlet(name = "institucionController", urlPatterns = {"/institucionController"})
public class institucionController extends HttpServlet {
    ...
    private void Listar(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        try {
            institucionDAO objeto = new institucionDAO();
            List<institucionesModel> lista = objeto.Listar();
    ...
    private void Seleccionar(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            institucionDAO objeto = new institucionDAO();
            List<institucionesModel> lista = objeto.Seleccionar(id);
            
            institucionesModel mostrar = lista.get(0);
    ...
    private void Registrar(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            institucionDAO objeto = new institucionDAO();
            Boolean bandera = objeto.Registrar(ins);
            ...
            if (bandera) {
                ...
                respuesta.put("redirect", "institucionesView.jsp");
            } else {
                respuesta.put("estado", "error");
                respuesta.put("mensaje", "No se puede crear.");
                respuesta.put("redirect", "institucionRegistrar.jsp");
            }
    ...
    private void Editar(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            institucionDAO objeto = new institucionDAO();
            Boolean bandera = objeto.Editar(ins, id);
            ...
            if (bandera) {
                ...
                respuesta.put("redirect", "institucionEditar.jsp");
            }
